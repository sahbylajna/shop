...
return [
    ...
    'produit_id' => 'Produit',
    'produit_id__placeholder' => 'Select produit',
    'color_id' => 'Color',
    'color_id__placeholder' => 'Select color',
    'size_id' => 'Size',
    ...
    'index_route_description' => 'Retrieve existing ordres.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the ordre property name where the value is the assigned value to the retrieved ordre.',
    ...
    'show_route_description' => 'Retrieve existsing ordre.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the ordre to retrieve',
    'destroy_route_description' => 'Delete existsing ordre.',
    ...
    'the_id_of_model_to_delete' => 'The id of the ordre to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete ordres.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the ordre.',
    ...
    'the_requested_model_does_not_exists' => 'The requested ordre does not exists.',
    ...
    'create' => 'Create New Ordre',
    'delete' => 'Delete Ordre',
    'edit' => 'Edit Ordre',
    'show' => 'Show Ordre',
    'show_all' => 'Show All Ordre',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Ordre.',
    'none_available' => 'No Ordres Available.',
    'model_plural' => 'Ordres',
    'model_was_added' => 'Ordre was successfully added.',
    'model_was_retrieved' => 'Ordre was successfully retrieved.',
    'models_were_retrieved' => 'Ordres were successfully retrieved.',
    'model_was_updated' => 'Ordre was successfully updated.',
    'model_was_deleted' => 'Ordre was successfully deleted.',
