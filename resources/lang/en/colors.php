...
return [
    ...
    'valeur' => 'Valeur',
    'valeur__placeholder' => 'Enter valeur here...',
    'access_token_with_bearer' => 'The access token prefixed with the "Bearer " key word.',
    'index_route_description' => 'Retrieve existing colors.',
    'index_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_key_is_the_model_property_and_the_value_is_the_model_value' => 'The array\'s key is the color property name where the value is the assigned value to the retrieved color.',
    ...
    'show_route_description' => 'Retrieve existsing color.',
    'show_route_response_description' => 'The API\'s response will be JSON based data. The JSON object will be structured as follow',
    'the_id_of_model_to_retrieve' => 'The unique id of the color to retrieve',
    'destroy_route_description' => 'Delete existsing color.',
    ...
    'the_id_of_model_to_delete' => 'The id of the color to delete.',
    'general_description' => 'Allows you to list, create, edit, show and delete colors.',
    'indicate_whether_the_request_was_successful_or_not' => 'Indicate whether the request was successful or not.',
    'the_id_of_the_model' => 'The id of the color.',
    ...
    'the_requested_model_does_not_exists' => 'The requested color does not exists.',
    ...
    'edit' => 'Edit Color',
    'show' => 'Show Color',
    'show_all' => 'Show All Color',
    'add' => 'Add',
    'update' => 'Update',
    'confirm_delete' => 'Click Ok to delete Color.',
    'none_available' => 'No Colors Available.',
    'model_plural' => 'Colors',
    'model_was_added' => 'Color was successfully added.',
    'model_was_retrieved' => 'Color was successfully retrieved.',
    'models_were_retrieved' => 'Colors were successfully retrieved.',
    'model_was_updated' => 'Color was successfully updated.',
    'model_was_deleted' => 'Color was successfully deleted.',
